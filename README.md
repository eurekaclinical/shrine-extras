...
These instructions assume you have already followed the automated install instructions on the SHRINE website. `$SHRINE_HOME` is the path to your SHRINE installation, usually `/opt/shrine`.
